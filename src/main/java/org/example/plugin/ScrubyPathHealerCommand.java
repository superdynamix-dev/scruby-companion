...
public final class ScrubyPathHealerCommand extends AbstractPlayerCommand {
    ...
    public ScrubyPathHealerCommand(
        ...
        super("scruby-path-healer", "Waehle den Healer-Pfad fuer deinen Companion (ab Level 5).");
    ...
    protected void execute(
        ...
        commandContext.sendMessage(Message.raw(
                ScrubyLang.get(locale, "cmd.path.success", ScrubyColors.pathDisplayName("HEALER", locale))));
