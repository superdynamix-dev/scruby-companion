...
public final class ScrubyChoose1Command extends AbstractPlayerCommand {
    ...
    public ScrubyChoose1Command(
        ...
        super("scruby-choose-1", "Choose skill option 1 for the next open choice slot.");
