...
public final class ScrubyPathTankCommand extends AbstractPlayerCommand {
    ...
    public ScrubyPathTankCommand(
        ...
        super("scruby-path-tank", "Waehle den Tank-Pfad fuer deinen Companion (ab Level 5).");
    ...
    protected void execute(
        ...
        commandContext.sendMessage(Message.raw(
                ScrubyLang.get(locale, "cmd.path.success", ScrubyColors.pathDisplayName("TANK", locale))));
